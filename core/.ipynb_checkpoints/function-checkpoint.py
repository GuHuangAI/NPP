...
def train(config, epoch, num_epoch, lr, trainloader, optimizer, model, criterion,writer_dict, device):
...
def validate(config, testloader, model, criterion, writer_dict, device):
