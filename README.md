...
## Train
Download the pretrained backbone from link: https://pan.baidu.com/s/1kvLBz1zvas_yupCXETnCIA 
with the extracing code: sl2o, and modify the model path in the line 205 of augment_lip_sybc.py.
